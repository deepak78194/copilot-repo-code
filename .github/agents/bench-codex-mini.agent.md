---
name: bench-codex-mini
description: "Benchmark sub-agent pinned to GPT-5.1-Codex-Mini (0.33x Budget). Used by the benchmark orchestrator for model comparison tests."
